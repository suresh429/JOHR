...
import com.journals.ijpcbs.databinding.FragmentJournalHomeBinding;
import com.journals.ijpcbs.helper.utils;
import com.journals.ijpcbs.ui.viewmodel.JournalHomeViewModel;
...
public class JournalHomeFragment extends Fragment {
    private static final String TAG = "JournalHomeFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        journalHomeViewModel.getJournalHomeRepository().observe(getViewLifecycleOwner(), homeResponse -> {
           // List<JournalHomeResponse> catDetailsBeanList = homeResponse.getAbt_journal_details();
            Log.d(TAG, "onCreateView: "+homeResponse.getAbtJournalDetails());
