package com.journals.ijpcbs.ui.adapter;
...
import com.journals.ijpcbs.R;
import com.journals.ijpcbs.databinding.EditorialBoardItemBinding;
import com.journals.ijpcbs.model.EditorialBoardResponse;
...
public class EditorialBoardAdapter extends RecyclerView.Adapter<EditorialBoardAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull EditorialBoardAdapter.ViewHolder holder, int position) {
        ...
        if (modelList.get(position).getUname() != null && !modelList.get(position).getUname().equalsIgnoreCase("null") && !modelList.get(position).getUname().isEmpty()
            ...
            if (modelList.get(position).getUname() != null && !modelList.get(position).getUname().equalsIgnoreCase("null") && !modelList.get(position).getUname().isEmpty()) {
                holder.rowItemBinding.txtView3.setText(Html.fromHtml(modelList.get(position).getUname() + " " + modelList.get(position).getEx_unv_name() + " " + modelList.get(position).getCountry_name()));
                ...
                holder.rowItemBinding.txtView3.setText(Html.fromHtml(modelList.get(position).getEx_unv_name() + " " + modelList.get(position).getCountry_name()));

            } else {
                holder.rowItemBinding.txtView3.setText(Html.fromHtml(modelList.get(position).getCountry_name()));
            }
